...
//             	print_r($_FILES['image']);exit;
            if(!empty($_FILES['image']['name'])){ 
              ...
              //  $config['allowed_types']  = 'jpg|png|pdf|jpeg|gif';
				...
				$this->session->set_flashdata('Your data inserted successfully');
				redirect('Student');
			}
...
//                        print_r($error); exit;
				...
				$this->session->set_flashdata('information updated successfully.');
				redirect('Student');
			}
